...
namespace GUITest
{
    public class DFFont2 : NewFont
    {
        ...
        {
            return new NewCharFontData((ox, oy), (sx, sy));
        }
        private static NewCharFontData GetChar(int ox, int oy, int sx, int sy, int offset)
        {
            return new NewCharFontData((ox, oy), (sx, sy), (0, offset));
        }

        private static readonly NewCharFontData[] _characterData = new NewCharFontData[]
        {
            // !
            GetChar(6, 487, 5, 19),
            // "
        ...
        public override NewCharFontData GetCharacterData(char character)
        {
            ...
            return NewCharFontData.Unsupported;
        }
    }
}