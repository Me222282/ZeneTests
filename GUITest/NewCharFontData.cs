...
namespace GUITest
{
    ...
    /// </summary>
    public struct NewCharFontData
    {
        public NewCharFontData(Vector2I texPos, Vector2I texSize)
        {
        ...
        public NewCharFontData(Vector2I texPos, Vector2I texSize, Vector2I offset)
        {
            TexturePosision = texPos;
            Size = texSize;
            ExtraOffset = offset;
        ...
        public NewCharFontData(Vector2I texPos, Vector2I texSize, Vector2I offset, int buffer)
        {
            TexturePosision = texPos;
            Size = texSize;
            ExtraOffset = offset;
        ...
        public static NewCharFontData Unsupported { get; } = new NewCharFontData();
    }
}
